...
namespace KioscoInformaticoBackend.Migrations
{
    ...
    [Migration("20241008192259_inicio")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KioskoInformaticoServices.Models.Cliente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KioskoInformaticoServices.Models.Compra", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KioskoInformaticoServices.Models.DetalleCompra", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KioskoInformaticoServices.Models.DetalleVenta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KioskoInformaticoServices.Models.Localidad", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KioskoInformaticoServices.Models.Producto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KioskoInformaticoServices.Models.Proveedor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KioskoInformaticoServices.Models.Venta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClienteId = 1,
                            Eliminado = false,
                            Fecha = new DateTime(2024, 10, 8, 16, 22, 58, 519, DateTimeKind.Local).AddTicks(5934),
                            FormaPago = 0,
                            Iva = 21m,
                            Total = 3000m
                        },
                        new
                        {
                            ...
                            ClienteId = 2,
                            Eliminado = false,
                            Fecha = new DateTime(2024, 10, 8, 16, 22, 58, 519, DateTimeKind.Local).AddTicks(5953),
                            FormaPago = 1,
                            Iva = 10m,
                            Total = 5000m
                        },
                        new
                        {
                            ...
                            ClienteId = 1,
                            Eliminado = false,
                            Fecha = new DateTime(2024, 10, 8, 16, 22, 58, 519, DateTimeKind.Local).AddTicks(5956),
                            FormaPago = 2,
                            Iva = 21m,
                            Total = 8000m
                        });
            ...
            modelBuilder.Entity("KioskoInformaticoServices.Models.Cliente", b =>
                {
                    b.HasOne("KioskoInformaticoServices.Models.Localidad", "Localidad")
                        .WithMany()
            ...
            modelBuilder.Entity("KioskoInformaticoServices.Models.Compra", b =>
                {
                    b.HasOne("KioskoInformaticoServices.Models.Proveedor", "Proveedor")
                        .WithMany()
            ...
            modelBuilder.Entity("KioskoInformaticoServices.Models.DetalleCompra", b =>
                {
                    b.HasOne("KioskoInformaticoServices.Models.Producto", "Producto")
                        .WithMany()
            ...
            modelBuilder.Entity("KioskoInformaticoServices.Models.DetalleVenta", b =>
                {
                    ...
                    b.HasOne("KioskoInformaticoServices.Models.Venta", "Venta")
                        .WithMany()
            ...
            modelBuilder.Entity("KioskoInformaticoServices.Models.Venta", b =>
                {
                    b.HasOne("KioskoInformaticoServices.Models.Cliente", "Cliente")
                        .WithMany()
